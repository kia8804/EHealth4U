 ...
 * @author khuon
 */
public class FrontDeskSearchDoctorUI extends javax.swing.JFrame {

    /**
     * Creates new form FrontDeskSearchPatientUI
     */
    public FrontDeskSearchDoctorUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrontDeskSearchDoctorUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrontDeskSearchDoctorUI().setVisible(true);
            }
        });
    }

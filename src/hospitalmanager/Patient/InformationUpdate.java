...
public class InformationUpdate extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(HomeAddress, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(HomeAddress, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddPatientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddPatientActionPerformed
        ...
        else
        {
            try
            {
                ...
                pw.println((LastName.getText()+"@patient.com,")+"1234,"+FirstName.getText()+','+LastName.getText()+','+PhoneNumber.getText()+','+
                           PhoneNumber.getText()+','+Email.getText()+','+DOB.getText()+','+HomeAddress.getText()+','+Gender.getSelectedItem()+"na");
                pw.flush();
                pw.close();
    ...
    private void FirstNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_FirstNameFocusGained
        ...
        if(DOB.getText().length()==0)DOB.setText("MM/DD/YYYY");
    ...
    private void DOBFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_DOBFocusGained
        if(DOB.getText().equals("MM/DD/YYYY"))DOB.setText("");
        if(LastName.getText().length()==0)LastName.setText("Last Name");
        if(FirstName.getText().length()==0)FirstName.setText("First Name");
        if(PhoneNumber.getText().length()==0)PhoneNumber.setText("Phone Number");
        if(Email.getText().length()==0)Email.setText("Email");
    ...
    private void HomeAddressFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_HomeAddressFocusGained
        if(HomeAddress.getText().equals("Home Address"))HomeAddress.setText("");
        if(LastName.getText().length()==0)LastName.setText("Last Name");
        if(DOB.getText().length()==0)DOB.setText("MM/DD/YYYY");
        if(PhoneNumber.getText().length()==0)PhoneNumber.setText("Phone Number");
        if(Email.getText().length()==0)Email.setText("Email");

 ...
 * @author khuon
 */
public class DoctorSearchPatientUI extends javax.swing.JFrame {

    /**
     * Creates new form FrontDeskSearchPatientUI
     */
    public DoctorSearchPatientUI() {
        initComponents();
    }
        ...
        try
        {
            ...
            while((line = br.readLine()) != null && !found)
            {
                ...
                if(SearchBy.getSelectedItem().equals("Phone Number"))
                {
                    ...
                    {
                        PrintWriter outFile = new PrintWriter("temp.csv");
                        
                        outFile.print(user[0] + "," + user[1] + "," + user[2] + "," + user[3] + "," + user[4] + "," + user[5] + user[6] + "," + user[7] + "," + user[8] + "," + user[9]);
                ...
                if(SearchBy.getSelectedItem().equals("Email") && user[0].contains("@guest.com"))
                {
                    ...
                    if(user[5].equals(Email))
                    {
                        ...
                        DoctorPatientVisit nextpage = new DoctorPatientVisit();
                        nextpage.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorSearchPatientUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorSearchPatientUI().setVisible(true);
            }
        });
    }
